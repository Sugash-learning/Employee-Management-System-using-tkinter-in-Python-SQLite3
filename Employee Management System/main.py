...
root = Tk()
root.title("Sugash IT Service & Consultancy Private Limited Employee Management System")
...
title = Label(entries_frame, text="Sugash IT Service & Consultancy Private Limited Employee Management System", font=("Calibri", 18, "bold"), bg="#535c68", fg="Black")
